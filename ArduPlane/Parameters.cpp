...
const AP_Param::Info Plane::var_info[] = {
    // @Param: kamikaze_lon
    // @DisplayName: kamikaze_lon
    // @Description: Longitude value of kamikaze location
    // @Range: -180.0 180.0
    // @User: Advanced
    GSCALAR(kamikaze_lon,         "KAMIKAZE_LON",    KAMIKAZE_LON_DEFAULT),

    // @Param: kamikaze_lat
    // @DisplayName: kamikaze_lat
    // @Description: Latitude value of kamikaze location
    // @Range: -180.0 180.0
    // @User: Advanced
    GSCALAR(kamikaze_lat,         "KAMIKAZE_LAT",    KAMIKAZE_LAT_DEFAULT),
